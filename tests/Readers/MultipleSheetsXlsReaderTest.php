...
class MultipleSheetsXlsReaderTest extends TestCase {
    ...
    public function testGet()
    {
        ...
        $this->assertInstanceOf(\TenantCloud\Excel\Collections\SheetCollection::class, $got);
    ...
    public function testSelectSheet()
    {
        ...
        $this->assertInstanceOf(\TenantCloud\Excel\Collections\RowCollection::class, $sheet);
        $this->assertCount(5, $sheet);
    }
