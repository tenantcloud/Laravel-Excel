<?php namespace TenantCloud\Excel\Classes;
...
use TenantCloud\Excel\Writers\CellWriter;
...
class LaravelExcelWorksheet extends PHPExcel_Worksheet {
    ...
    public function __construct(PHPExcel $pParent = null, $pTitle = 'Worksheet')
    {
        ...
        $this->autoGenerateHeading = config('old_excel.export.generate_heading_by_indices', true);
    }
    ...
    public function setDefaultPageSetup()
    {
        ...
        foreach ($this->allowedPageSetup as $setup)
        {
            ...
            // get the value
            $value = config('old_excel.sheets.pageSetup.' . $setup, null);
        ...
        $this->setPageMargin(config('old_excel.export.sheets.page_margin', false));
    }
    ...
    public function getAutosize()
    {
        ...
        return config('old_excel.export.autosize', true);
    }
    ...
    public function mergeCells($pRange = 'A1:A1', $alignment = false)
    {
        ...
        {
            $aligment = is_string($alignment) ? $alignment : config('old_excel.export.merged_cell_alignment', 'left');
    ...
    {
        return config('old_excel.export.sheets.nullValue', null);
    }
    ...
    {
        return config('old_excel.export.sheets.startCell', 'A1');
    }
    ...
    {
        return config('old_excel.export.sheets.strictNullComparison', false);
    }
