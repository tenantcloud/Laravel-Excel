<?php namespace TenantCloud\Excel;

use PHPExcel_Settings;
use PHPExcel_Shared_Font;
use TenantCloud\Excel\Readers\Html;
use TenantCloud\Excel\Classes\Cache;
use TenantCloud\Excel\Classes\PHPExcel;
use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\Response;
use TenantCloud\Excel\Parsers\CssParser;
use TenantCloud\Excel\Parsers\ViewParser;
use TenantCloud\Excel\Classes\FormatIdentifier;
use TenantCloud\Excel\Readers\LaravelExcelReader;
use TenantCloud\Excel\Writers\LaravelExcelWriter;
...
class ExcelServiceProvider extends ServiceProvider {
    ...
    public function boot()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__ . '/../../config/old_excel.php', 'old_excel'
        );
    ...
    {
        $method = config('old_excel.export.autosize-method', PHPExcel_Shared_Font::AUTOSIZE_METHOD_APPROX);
